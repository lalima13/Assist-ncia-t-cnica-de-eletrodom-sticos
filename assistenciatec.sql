...
update servicos set statusos='Retirado' where idcli = 1;
update servicos set statusos='Retirado' where idcli = 6;
update servicos set statusos='Retirado' where idcli = 9;
update servicos set valor='399.00' where idcli = 9;
update servicos set valor='299.00' where idcli = 1;

select * from servicos;
describe servicos;
select * from servicos inner join clientes on servicos.idcli = clientes.idcli;

select servicos.produto,servicos.defeito,servicos.statusos as status_os,servicos.valor,clientes.nome,clientes.fone from servicos inner join clientes
on servicos.idcli = clientes.idcli where statusos = 'Aguardando';

select servicos.os,date_format(servicos.dataos, '%d/%m/%Y - %H:%i') as data_os,servicos.produto,servicos.defeito,servicos.valor,clientes.nome as cliente
from servicos inner join clientes on servicos.idcli = clientes.idcli where statusos = 'retirado';

select sum(valor) as faturamento from servicos where statusos = 'retirado';
